...
// --- Komponen Individual Card Soal (Universal) ---
...
export default function SemuaSoal() {
	...
	// Efek khusus untuk mengambil total SELURUH soal di database (hanya dipanggil sekali)
	useEffect(() => {
	...
	useEffect(() => {
		async function fetchQuestions() {
			...
			// Urutkan berdasarkan yang terbaru ditambahkan (atau bisa juga berdasarkan kode)
			query = query
		...
		<div className="py-8 md:py-12 animate-in fade-in duration-500">
			...
			<div className="mb-10">
				...
				<p className="text-slate-500 max-w-2xl leading-relaxed text-sm md:text-base">
					Jelajahi seluruh arsip problem solving yang tersedia di
					database kami.
				</p>
			</div>
			...
			{/* Banner Total Soal */}
			{globalTotal > 0 && (
				<div className="mb-8 p-5 sm:p-6 bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl shadow-lg shadow-slate-900/20 text-white flex items-center gap-4 relative overflow-hidden">
					<div className="absolute -right-10 -top-10 w-40 h-40 bg-blue-500 opacity-20 rounded-full blur-3xl"></div>
